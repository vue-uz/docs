...
## Vue-ni kim qo'llab-quvvatlaydi? {#who-maintains-vue}
...
## Vue 2 va Vue 3 o'rtasidagi farq nima? {#what-s-the-difference-between-vue-2-and-vue-3}
...
## Vue 2 hali ham qo'llab-quvvatlanadimi? {#is-vue-2-still-supported}
...
## Vue qanday litsenziyadan foydalanadi? {#what-license-does-vue-use}

Vue bepul va ochiq manbali loyiha bo'lib, [MIT litsenziyasi](https://opensource.org/licenses/MIT) ostida chiqariladi.

## Vue qaysi brauzerlarni qo'llab-quvvatlaydi? {#what-browsers-does-vue-support}
...
## Vue ishonchlimi? {#is-vue-reliable}
...
## Vue yengilmi? {#is-vue-lightweight}
...
## Vue kengayadimi? {#does-vue-scale}
...
## Vue-ga qanday hissa qo'sha olaman? {#how-do-i-contribute-to-vue}

Qiziqishingizni qadrlaymiz! Iltimos, bizning [Jamoa qo'llanmasini](/about/community-guide) ko'rib chiqing.

## Options API yoki Composition API-dan foydalanishim kerakmi? {#should-i-use-options-api-or-composition-api}
...
## Vue bilan JavaScript yoki TypeScript-dan foydalanishim kerakmi? {#should-i-use-javascript-or-typescript-with-vue}
...
## Vue veb-komponentlar bilan qanday taqqoslanadi? {#how-does-vue-compare-to-web-components}
